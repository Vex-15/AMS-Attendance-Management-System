    ...
    <nav className="bg-sidebar text-sidebar-foreground border-b border-sidebar-border">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <Link href="/dashboard/admin" className="font-bold text-lg hover:opacity-80">
              MITAOE
            </Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link href="/dashboard/admin" className="text-sm hover:text-sidebar-primary transition">
            System Status
          </Link>
          <Link href="/dashboard/admin" className="text-sm hover:text-sidebar-primary transition">
            Settings
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-sidebar-accent/10 border-t border-sidebar-border p-4 space-y-4">
          <Link href="/dashboard/admin" className="block text-sm hover:text-sidebar-primary">
            System Status
          </Link>
          <Link href="/dashboard/admin" className="block text-sm hover:text-sidebar-primary">
            Settings
